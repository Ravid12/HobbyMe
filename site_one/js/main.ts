...
function get_photos(setid, lim, check) {    
    ...
    var apikey: string = '52e55bf0e7329f969a6fc48b5c4a5276';
...
function end() {
    var check: number = 1;
    var sport: any = document.forms[0];
    var tech: any = document.forms[1];
    var art: any = document.forms[2];
    var music: any = document.forms[3];
    var travel: any = document.forms[4];
    ...
    if (sport != 0 && tech != 0 && art != 0 && music != 0 && travel != 0) {
        ...
        //SPORTS
        var setid: string = '72157673335326035';
        check = get_photos(setid, sport, check);
        //TECH
        var setid: string = '72157672309403881';
        check = get_photos(setid, tech, check);
        //ART
        var setid: string = '72157673335312265';
        check = get_photos(setid, art, check);
        //MUSIC
        var setid: string = '72157673335318425';
        check = get_photos(setid, music, check);
        //TRAVEL
        var setid: string = '72157673335302585';
